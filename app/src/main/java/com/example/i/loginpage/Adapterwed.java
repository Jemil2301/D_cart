...
public class Adapterwed extends PagerAdapter {
    private Context context;
    private LayoutInflater layoutInflater;
    private Integer[] image={R.drawable.wedding1,R.drawable.wedding2,R.drawable.wedding3};
    public Adapterwed(Context context) {
