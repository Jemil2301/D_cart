...
public class Payment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prprice = getIntent().getExtras().getString("Price");
        for(int i=0;i<=2;i++) {
            if (prprice.charAt(0) == 'R' || prprice.charAt(0) == 's' || prprice.charAt(0) == '.') { // Remove all the # chars in front of the real string
                prprice = prprice.substring(1, prprice.length());
            }
        }
        amountEt.setText(prprice);
